...
checkpoint:
  ...
  gray_areas_resolved:
    ...
    - topic: "MVP flow"
      decision: "sign-up → add plant by name → AI lookup → review/accept → plant list with status → mark as watered"
    - topic: "mvp timeline"
      decision: "3 weeks after-hours work"
    - topic: "notifications in MVP"
      decision: "out of MVP scope — not in the 6-step flow"
  frs_drafted: 10
